...
public class AbstractController<S extends IService<T>,T>{
	...
	@ApiOperation(value = "获取对象", notes = "作者：liuxun")
	...
	@ApiOperation(value = "删除", notes = "作者：liuxun")
	 ...
	 */
	@PostMapping("/insert")
	@ApiOperation(value = "添加", notes = "作者：liuxun")
	 ...
	 */
	@PostMapping("/update")
	@ApiOperation(value = "修改", notes = "作者：liuxun")
	 ...
	 */
	@GetMapping("/getPages")
	@ApiOperation(value = "分页查询", notes = "分页查询返回[IPage<T>],作者：liuxun")
